...
type
  TfrmTempo = class(TForm)
    ...
    procedure SetDSP_EQ(fGain, fBandwidth, fQ, fCenter_Bass, fCenter_Mid, fCenter_Treble: Single);
  private
    ...
    freq: Single;               // sample rate
    oldfreq: Single;            // old sample rate
  public
    { Public declarations }
  end;
...
// Set DSP Peaking EQ
procedure TfrmTempo.SetDSP_EQ(fGain, fBandwidth, fQ, fCenter_Bass, fCenter_Mid, fCenter_Treble: Single);
begin
